package jp.tokuo.sand.configuration;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public static final String TOP_PAGE_URL = "/hoge";
...
//  }
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests()
        .antMatchers(LOGIN_URL, ERROR_URL).permitAll() // 全許可
    ...
    http.formLogin().loginPage(LOGIN_URL)
        ...
        .successHandler(new SuccessHandler()) // 認証成功時のコールハンドラ
